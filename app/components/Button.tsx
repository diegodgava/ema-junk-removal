...
const Button: React.FC = () => {
    return (
        <div className="fixed bottom-4 right-4 flex items-center">
          <button className="bg-customRed hover:bg-red-700 text-white font-bold py-1 px-3 rounded-full flex flex-col items-center">
            ...
            <span className='text-xs'>Book Online</span>
          </button>
        </div>
      );
    };
